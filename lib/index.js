...
var _page = function () {
  ...
  (0, _createClass3.default)(page, [{
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                date = this.opt.desc ? "r-" + (253370732400000 - Date.now()) : Date.now();
              ...
              case 5:
                ...
                _context.next = 8;
                return (_node2 = this.node).gput.apply(_node2, [data].concat((0, _toConsumableArray3.default)(this.keys), [date + ":" + id + (this.opt.hash ? "#" : ""), this.opt]));
              ...
              case 11:
                _context.next = 13;
                return (_node3 = this.node).put.apply(_node3, [data].concat((0, _toConsumableArray3.default)(this.keys), [date + ":" + id + (this.opt.hash ? "#" : ""), this.opt]));
    ...
    key: "checkNew",
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(cb) {
        var _this2 = this;
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return this.listenNew(function (data, key) {
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                d = Date.now();
                cond = this.opt.desc ? { ".": { ">": "r-" + start, "<": "r-253370732400000" }, "%": 1000000 } : { ".": { ">": start, "<": "253370732400000" }, "%": 1000000 };
                ...
                _context6.next = 5;
                return (_node4 = this.node).gmap.apply(_node4, (0, _toConsumableArray3.default)(this.keys).concat([cond, this.opt, function (data) {
              ...
              case 7:
                ...
                _context6.next = 10;
                return (_node5 = this.node).map.apply(_node5, (0, _toConsumableArray3.default)(this.keys).concat([cond, this.opt, function (data) {
              ...
              case 12:
                _context6.next = 14;
                return (_node6 = this.node).umap.apply(_node6, [this.type].concat((0, _toConsumableArray3.default)(this.keys), [cond, this.opt, function (data) {
                  return _this3.parse(data, cb, broadcast);
                }]));
...
var db = function () {
  ...
  (0, _createClass3.default)(db, [{
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                _context15.t2 = SEA;
                _context15.t3 = epub;
                _context15.t4 = _ramda.defaultTo;
                _context15.next = 7;
                return this.auth_user.pair();

              case 7:
                _context15.t5 = _context15.sent;
                _context15.t6 = (0, _context15.t4)(_context15.t5);
                _context15.t7 = pair;
                _context15.t8 = (0, _context15.t6)(_context15.t7);
                _context15.next = 13;
                return _context15.t2.secret.call(_context15.t2, _context15.t3, _context15.t8);

              case 13:
                _context15.t9 = _context15.sent;
                _context15.next = 16;
                return _context15.t0.encrypt.call(_context15.t0, _context15.t1, _context15.t9);
                    ...
                    return _regenerator2.default.wrap(function _callee27$(_context27) {
                      while (1) {
                        switch (_context27.prev = _context27.next) {
                          case 0:
                            _this5.node.apply(_this5, [node].concat((0, _toConsumableArray3.default)(keys))).once(function () {
    ...
    value: function () {
      ...
      function decryptMessage(_x30, _x31, _x32) {
          ...
          while (1) {
            switch (_context30.prev = _context30.next) {
              ...
              case 51:
                ...
                _context30.next = 54;
                return _context30.t15._dec.call(_context30.t15, _context30.t16, _context30.t17);
              ...
              case 60:
                _context30.t18 = _context30.sent;
                _context30.next = 64;
                break;
    ...
    value: function () {
      ...
      function encryptMessage(_x42, _x43, _x44) {
                    ...
                    return _regenerator2.default.wrap(function _callee38$(_context38) {
                      while (1) {
                        switch (_context38.prev = _context38.next) {
                          case 0:
                            _this7.node.apply(_this7, [node].concat((0, _toConsumableArray3.default)(keys))).put(enc, function (data) {
                              return ret(data);
                            });
