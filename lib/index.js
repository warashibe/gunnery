...
var _page = function () {
  ...
  (0, _createClass3.default)(page, [{
    key: "blacklistIds",
    value: function blacklistIds(ids) {
      ...
      try {
        for (var _iterator = (0, _getIterator3.default)(ids), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var v = _step.value;
          this.blacklist[v.split("#")[0].split(":")[1]] = true;
        }
      } catch (err) {
    ...
    value: function parse(data, cb) {
      ...
      try {
        var key = data._key;
        if (!(0, _ramda.isNil)(data) && data.deleted !== true && this.blacklist[key.split("#")[0].split(":")[1]] !== true) {
          this.items[key] = data;
    ...
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7() {
        ...
        var arr, i, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, v;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.prev = 6;
                _iterator2 = (0, _getIterator3.default)(this.arr);
              ...
              case 14:
                if ((0, _ramda.isNil)(this.blacklist[v._key.split("#")[0].split(":")[1]])) arr.push(v);
                i += 1;
                this.cursor = i + 1;
        ...
        }, _callee7, this, [[6, 24, 28, 36], [29,, 31, 35]]);
      }));
...
var db = function () {
  ...
  (0, _createClass3.default)(db, [{
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 20:
                key = _context8.sent;
                _context8.next = 23;
                return this.uget.apply(this, [pub].concat((0, _toConsumableArray3.default)(args), [{ timeout: 3000 }]));
            ...
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                return new _promise2.default(function (ret) {
                  user.on(function () {
                    var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(_user, key, msg, ev) {
                      return _regenerator2.default.wrap(function _callee12$(_context12) {
                        while (1) {
                          switch (_context12.prev = _context12.next) {
                            case 0:
                              if (!(0, _ramda.isNil)(_user)) {
                                _this4.pairs[pub] = _user;
                                _this4.users[pub] = user;
                                try {
                                  ev.off();
                                } catch (e) {}
                                ret(_user);
                      ...
                      while (1) {
                        switch (_context27.prev = _context27.next) {
                          case 0:
                            ...
                            _this5.node.apply(_this5, [node, opt].concat((0, _toConsumableArray3.default)(keys)))[(0, _ramda.isNil)(opt.timeout) ? "once" : "on"](function () {
                              var _ref28 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee26(data, key, msg, ev) {
                                var dec;
                                return _regenerator2.default.wrap(function _callee26$(_context26) {
                                  while (1) {
                                    switch (_context26.prev = _context26.next) {
                                      case 0:
                                        if (!(0, _ramda.isNil)(opt.timeout)) {
                                          _context26.next = 7;
                                          break;
                                        }
    ...
    value: function () {
      ...
      function decryptMessage(_x37, _x38, _x39) {
                      ...
                      while (1) {
                        switch (_context31.prev = _context31.next) {
                          ...
                          case 2:
                            ...
                            cb((0, _ramda.isNil)(dec) ? null : (0, _ramda.mergeLeft)({ _key: key }, dec), opt.on ? ev.off : null);
    ...
    value: function () {
      ...
      function encryptMessage(_x49, _x50, _x51) {
