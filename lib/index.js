...
var db = function () {
  ...
  (0, _createClass3.default)(db, [{
    ...
    value: function _args(args) {
      ...
      var opt = (0, _ramda.ifElse)((0, _ramda.o)(isOpt, _ramda.last), _ramda.last, (0, _ramda.always)({}))(args);
      var keys = (0, _ramda.when)((0, _ramda.o)(isOpt, _ramda.last), _ramda.init)(args);
      return [opt, keys];
    }
  }, {
    key: "_onargs",
    ...
    value: function () {
      var _ref24 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee25(node, val) {
        ...
        var _args29, _args30, opt, keys, enc, hash;
